...
public class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        Book[] books = {
            new Book(1, "Java Programming", "Rahul"),
            new Book(2, "Data Structures", "Anish"),
            new Book(3, "Algorithms", "Sudhansu"),
            new Book(4, "Operating Systems", "Jiggi"),
            new Book(5, "Database Systems", "Anu")
        };
