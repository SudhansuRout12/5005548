...
public class EmployeeManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        // Add employees
        ems.addEmployee(new Employee(1, "Sudhansu Rout", "Software Engineer", 75000));
        ems.addEmployee(new Employee(2, "Anish Mohanty", "Project Manager", 85000));
        ems.addEmployee(new Employee(3, "Biswarup Pal", "Analyst", 70000));
        ems.addEmployee(new Employee(4, "Rahul Swain", "UX Designer", 72000));
        ems.addEmployee(new Employee(5, "Deepti Bhuyan", "HR Manager", 68000));
